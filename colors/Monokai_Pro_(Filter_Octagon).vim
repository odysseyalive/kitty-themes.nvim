" Monokai_Pro_(Filter_Octagon) colorscheme for Neovim
" Generated from kitty theme: Monokai_Pro_(Filter_Octagon)
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'Monokai_Pro_(Filter_Octagon)'
set termguicolors
" Define colors
let s:none = 'NONE'
...
let s:color8 = '#696d77'
let s:color9 = '#ff657a'
let s:color10 = '#bad761'
let s:color11 = '#ffd76d'
let s:color12 = '#ff9b5e'
let s:color13 = '#c39ac9'
let s:color14 = '#9cd1bb'
let s:color15 = '#eaf2f1'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#ff657a')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#ffd76d')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#ff9b5e')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#9cd1bb')
