...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#ab2e30')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#ab4200')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#2c56ab')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#1fa5ab')
