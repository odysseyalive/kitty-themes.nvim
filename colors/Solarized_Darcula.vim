" Solarized_Darcula colorscheme for Neovim
" Generated from kitty theme: Solarized_Darcula
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'Solarized_Darcula'
set termguicolors
" Define colors
let s:none = 'NONE'
let s:bg_solid = '#3d3f41'
...
let s:color8 = '#25292a'
let s:color9 = '#f24840'
let s:color10 = '#629655'
let s:color11 = '#b68800'
let s:color12 = '#2074c7'
let s:color13 = '#797fd4'
let s:color14 = '#15968d'
let s:color15 = '#d2d8d9'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#f24840')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#b68800')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#2074c7')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#15968d')
