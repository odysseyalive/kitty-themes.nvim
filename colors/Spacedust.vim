" Spacedust colorscheme for Neovim
" Generated from kitty theme: Spacedust
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#674c31'
let s:color9 = '#ff8a39'
let s:color10 = '#adcab8'
let s:color11 = '#ffc777'
let s:color12 = '#67a0cd'
let s:color13 = '#ff8a39'
let s:color14 = '#83a6b3'
let s:color15 = '#fefff0'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#e35a00')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#e3cd7b')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#0e548b')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#06afc7')
