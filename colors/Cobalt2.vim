" Cobalt2 colorscheme for Neovim
" Generated from kitty theme: Cobalt2
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#545454'
let s:color9 = '#f40d17'
let s:color10 = '#3bcf1d'
let s:color11 = '#ecc809'
let s:color12 = '#5555ff'
let s:color13 = '#ff55ff'
let s:color14 = '#6ae3f9'
...
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#fee409')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#1460d2')
