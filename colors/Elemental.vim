" Elemental colorscheme for Neovim
" Generated from kitty theme: Elemental
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#545444'
let s:color9 = '#df502a'
let s:color10 = '#60e06f'
let s:color11 = '#d69827'
let s:color12 = '#78d8d8'
let s:color13 = '#cd7c53'
let s:color14 = '#58d598'
let s:color15 = '#fff1e8'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#97280f')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#7f7110')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#497f7d')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#387f58')
