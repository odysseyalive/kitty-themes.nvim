" Symfonic colorscheme for Neovim
" Generated from kitty theme: Symfonic
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#dc322f')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#ff8400')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#0084d4')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#ccccff')
...
let s:color8 = '#1b1d21'
let s:color9 = '#dc322f'
let s:color10 = '#56db3a'
let s:color11 = '#ff8400'
let s:color12 = '#0084d4'
let s:color13 = '#b729d9'
let s:color14 = '#ccccff'
