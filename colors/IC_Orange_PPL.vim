...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#c03900')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#caae00')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#bd6c00')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#f79400')
