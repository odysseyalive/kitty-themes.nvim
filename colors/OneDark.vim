...
" Generated from kitty theme: OneDark
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#e06c75')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#e5c07b')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#61afef')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#56b6c2')
...
let s:color11 = '#e5c07b'
let s:color12 = '#61afef'
let s:color13 = '#be5046'
let s:color14 = '#56b6c2'
let s:color15 = '#abb2bf'
