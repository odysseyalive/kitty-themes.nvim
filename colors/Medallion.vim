" Medallion colorscheme for Neovim
" Generated from kitty theme: Medallion
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#b54c00')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#d2bd25')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#606baf')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#906b25')
...
let s:color8 = '#5e5118'
let s:color9 = '#ff9148'
let s:color10 = '#b1c93a'
let s:color11 = '#ffe449'
let s:color12 = '#abb8ff'
let s:color13 = '#fe9fff'
let s:color14 = '#ffbb51'
let s:color15 = '#fed597'
