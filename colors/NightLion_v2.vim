" NightLion_v2 colorscheme for Neovim
" Generated from kitty theme: NightLion_v2
...
let g:colors_name = 'NightLion_v2'
set termguicolors
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#bb0000')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#f2f067')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#63d0f0')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#00d9df')
...
let s:color8 = '#545454'
let s:color9 = '#ff5555'
let s:color10 = '#7df61c'
let s:color11 = '#ffff55'
let s:color12 = '#62cae7'
let s:color13 = '#ff9af5'
let s:color14 = '#00ccd7'
