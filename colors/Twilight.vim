" Twilight colorscheme for Neovim
" Generated from kitty theme: Twilight
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#262626'
let s:color9 = '#dd7c4c'
let s:color10 = '#cbd88c'
let s:color11 = '#e1c47d'
let s:color12 = '#5a5d61'
let s:color13 = '#d0db8e'
let s:color14 = '#8a989a'
let s:color15 = '#feffd3'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#c06c43')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#c2a86c')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#444649')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#778284')
