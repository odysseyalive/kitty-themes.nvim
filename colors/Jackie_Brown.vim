" Jackie_Brown colorscheme for Neovim
" Generated from kitty theme: Jackie_Brown
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'Jackie_Brown'
set termguicolors
" Define colors
let s:none = 'NONE'
let s:bg_solid = '#2c1c15'
let s:bg = get(g:, 'kitty_themes_transparent', 0) ? s:none : s:bg_solid
let s:fg = '#ffcc2f'
let s:cursor = '#23ff18'
let s:selection = '#ae8c20'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#ef5734')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#bdbe00')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#246db2')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#00acee')
