" BirdsOfParadise colorscheme for Neovim
" Generated from kitty theme: BirdsOfParadise
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#9a6b49'
let s:color9 = '#e84526'
let s:color10 = '#94d7ba'
let s:color11 = '#d0d04f'
let s:color12 = '#b8d3ed'
let s:color13 = '#d09dca'
let s:color14 = '#92ced6'
let s:color15 = '#fff9d4'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#be2d26')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#e99c29')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#5a86ac')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#74a5ac')
