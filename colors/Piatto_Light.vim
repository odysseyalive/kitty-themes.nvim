" Piatto_Light colorscheme for Neovim
" Generated from kitty theme: Piatto_Light
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'Piatto_Light'
set termguicolors
" Define colors
let s:none = 'NONE'
let s:bg_solid = '#ffffff'
...
let s:color8 = '#3e3e3e'
let s:color9 = '#da3365'
let s:color10 = '#829428'
let s:color11 = '#cc6e33'
let s:color12 = '#3b5ea7'
let s:color13 = '#a353b2'
let s:color14 = '#829428'
let s:color15 = '#f1f1f1'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#b23670')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#cc6e33')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#3b5ea7')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#66781d')
