" Rippedcasts colorscheme for Neovim
" Generated from kitty theme: Rippedcasts
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#666666'
let s:color9 = '#edcbac'
let s:color10 = '#bced68'
let s:color11 = '#e5e500'
let s:color12 = '#86bdc8'
let s:color13 = '#e500e5'
let s:color14 = '#8b9bc4'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#ccae95')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#beba1f')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#74a4af')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#5a637e')
