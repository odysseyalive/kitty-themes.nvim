" Monokai_Soda colorscheme for Neovim
" Generated from kitty theme: Monokai_Soda
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'Monokai_Soda'
set termguicolors
" Define colors
let s:none = 'NONE'
let s:bg_solid = '#191919'
let s:bg = get(g:, 'kitty_themes_transparent', 0) ? s:none : s:bg_solid
let s:fg = '#c4c4b5'
let s:cursor = '#f6f6ec'
let s:selection = '#343434'
...
let s:color8 = '#615e4b'
let s:color9 = '#f3005f'
let s:color10 = '#97e023'
let s:color11 = '#dfd561'
let s:color12 = '#9c64fe'
let s:color13 = '#f3005f'
let s:color14 = '#57d1ea'
let s:color15 = '#f6f6ee'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#f3005f')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#fa8419')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#9c64fe')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#57d1ea')
