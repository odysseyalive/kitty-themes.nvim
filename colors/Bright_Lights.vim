" Bright_Lights colorscheme for Neovim
" Generated from kitty theme: Bright_Lights
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#191919'
let s:color9 = '#ff355b'
let s:color10 = '#b6e875'
let s:color11 = '#ffc150'
let s:color12 = '#75d4ff'
let s:color13 = '#b975e6'
let s:color14 = '#6cbeb5'
let s:color15 = '#c1c8d6'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#ff355b')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#ffc150')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#75d3ff')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#6cbeb5')
