" Dumbledore colorscheme for Neovim
" Generated from kitty theme: Dumbledore
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'Dumbledore'
set termguicolors
" Define colors
let s:none = 'NONE'
let s:bg_solid = '#422553'
...
let s:color8 = '#413e53'
let s:color9 = '#d3a624'
let s:color10 = '#aaaaaa'
let s:color11 = '#716254'
let s:color12 = '#946a2c'
let s:color13 = '#b294ba'
let s:color14 = '#25de50'
let s:color15 = '#c9c9c9'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#ae0000')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#f0c75e')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#415baf')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#008aff')
