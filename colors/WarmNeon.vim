" WarmNeon colorscheme for Neovim
" Generated from kitty theme: WarmNeon
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'WarmNeon'
set termguicolors
" Define colors
let s:none = 'NONE'
let s:bg_solid = '#3f3f3f'
let s:bg = get(g:, 'kitty_themes_transparent', 0) ? s:none : s:bg_solid
let s:fg = '#afdab6'
let s:cursor = '#2fff24'
let s:selection = '#b0ad21'
...
let s:color8 = '#fdfcfc'
let s:color9 = '#e86f71'
let s:color10 = '#9bc08f'
let s:color11 = '#ddd979'
let s:color12 = '#7a90d5'
let s:color13 = '#f674b9'
let s:color14 = '#5ed1e4'
let s:color15 = '#d8c8bb'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#e24345')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#dae145')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#4260c5')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#29bad3')
