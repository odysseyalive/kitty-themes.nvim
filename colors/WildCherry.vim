" WildCherry colorscheme for Neovim
" Generated from kitty theme: WildCherry
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#d94085')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#ffd06e')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#873bdb')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#c1b8b6')
...
let s:color8 = '#009cc9'
let s:color9 = '#da6bab'
let s:color10 = '#f4dba5'
let s:color11 = '#eac066'
let s:color12 = '#2f8bb9'
let s:color13 = '#ae636b'
let s:color14 = '#ff919d'
let s:color15 = '#e4838d'
