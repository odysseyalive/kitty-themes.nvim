" FunForrest colorscheme for Neovim
" Generated from kitty theme: FunForrest
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'FunForrest'
set termguicolors
" Define colors
let s:none = 'NONE'
let s:bg_solid = '#241200'
...
let s:color8 = '#7e6954'
let s:color9 = '#e4591b'
let s:color10 = '#bfc659'
let s:color11 = '#ffca1b'
let s:color12 = '#7cc9ce'
let s:color13 = '#d16349'
let s:color14 = '#e6a96b'
let s:color15 = '#ffe9a3'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#d5252b')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#bd8a13')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#4698a2')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#d98112')
