" idleToes colorscheme for Neovim
" Generated from kitty theme: idleToes
...
let g:colors_name = 'idleToes'
set termguicolors

" Define colors
let s:none = 'NONE'
let s:bg_solid = '#323232'
let s:bg = get(g:, 'kitty_themes_transparent', 0) ? s:none : s:bg_solid
let s:fg = '#ffffff'
let s:cursor = '#d6d6d6'
let s:selection = '#5b5b5b'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#d25252')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#ffc66d')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#4098ff')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#bed6ff')
...
let s:color8 = '#535353'
let s:color9 = '#f07070'
let s:color10 = '#9dff90'
let s:color11 = '#ffe48b'
let s:color12 = '#5eb7f7'
let s:color13 = '#ff9dff'
let s:color14 = '#dcf4ff'
