" SoftServer colorscheme for Neovim
" Generated from kitty theme: SoftServer
...
let g:colors_name = 'SoftServer'
set termguicolors

" Define colors
let s:none = 'NONE'
let s:bg_solid = '#242626'
let s:bg = get(g:, 'kitty_themes_transparent', 0) ? s:none : s:bg_solid
let s:fg = '#99a3a2'
let s:cursor = '#d1dfde'
let s:selection = '#7f8786'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#a16869')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#a29069')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#6a8fa3')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#6ba48f')
...
let s:color8 = '#666c6b'
let s:color9 = '#dc5b5f'
let s:color10 = '#bfde54'
let s:color11 = '#deb35f'
let s:color12 = '#62b1df'
let s:color13 = '#5f6ede'
let s:color14 = '#64e39c'
let s:color15 = '#d1dfde'
