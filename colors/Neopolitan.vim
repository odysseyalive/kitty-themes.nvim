" Neopolitan colorscheme for Neovim
" Generated from kitty theme: Neopolitan
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#000000'
let s:color9 = '#800000'
let s:color10 = '#61ce3c'
let s:color11 = '#fbde2d'
let s:color12 = '#253b76'
let s:color13 = '#ff0080'
let s:color14 = '#8da6ce'
let s:color15 = '#f8f8f8'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#800000')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#fbde2d')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#253b76')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#8da6ce')
