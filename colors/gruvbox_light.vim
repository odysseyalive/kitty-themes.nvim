" gruvbox_light colorscheme for Neovim
" Generated from kitty theme: gruvbox_light
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#282828'
let s:color9 = '#9d0006'
let s:color10 = '#79740e'
let s:color11 = '#b57614'
let s:color12 = '#076678'
let s:color13 = '#8f3f71'
let s:color14 = '#427b58'
let s:color15 = '#928374'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#cc241d')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#d79921')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#458588')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#689d6a')
