" Borland colorscheme for Neovim
" Generated from kitty theme: Borland
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#7c7c7c'
let s:color9 = '#ffb6b0'
let s:color10 = '#ceffab'
let s:color11 = '#ffffcb'
let s:color12 = '#b5dcfe'
let s:color13 = '#ff9cfe'
let s:color14 = '#dfdffe'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#ff6b60')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#ffffb6')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#96cafd')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#c6c4fd')
