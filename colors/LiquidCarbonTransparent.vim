" LiquidCarbonTransparent colorscheme for Neovim
" Generated from kitty theme: LiquidCarbonTransparent
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'LiquidCarbonTransparent'
set termguicolors
" Define colors
let s:none = 'NONE'
