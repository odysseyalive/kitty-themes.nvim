...
" Generated from kitty theme: Jellybeans
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#bdbdbd'
let s:color9 = '#ffa0a0'
let s:color10 = '#bddeab'
let s:color11 = '#ffdba0'
let s:color12 = '#b1d7f6'
let s:color13 = '#fbdaff'
let s:color14 = '#19b2a7'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#e17373')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#ffb97b')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#96bddb')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#00988e')
