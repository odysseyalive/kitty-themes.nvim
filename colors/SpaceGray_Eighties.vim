" SpaceGray_Eighties colorscheme for Neovim
" Generated from kitty theme: SpaceGray_Eighties
...
let g:colors_name = 'SpaceGray_Eighties'
set termguicolors
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#ec5f67')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#fdc253')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#5485c0')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#57c2c0')
...
let s:color8 = '#545454'
let s:color9 = '#ff6973'
let s:color10 = '#93d393'
let s:color11 = '#ffd156'
let s:color12 = '#4d83d0'
let s:color13 = '#ff55ff'
let s:color14 = '#83e8e4'
