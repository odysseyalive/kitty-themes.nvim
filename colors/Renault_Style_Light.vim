" Renault_Style_Light colorscheme for Neovim
" Generated from kitty theme: Renault_Style_Light
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'Renault_Style_Light'
set termguicolors
" Define colors
let s:none = 'NONE'
...
let s:color8 = '#323232'
let s:color9 = '#ff7b6a'
let s:color10 = '#83d082'
let s:color11 = '#ffff7b'
let s:color12 = '#9fcef0'
let s:color13 = '#ffffff'
let s:color14 = '#a4d4f8'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#da4839')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#ffd249')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#46657d')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#87c1f1')
