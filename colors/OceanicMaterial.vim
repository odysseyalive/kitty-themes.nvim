" OceanicMaterial colorscheme for Neovim
" Generated from kitty theme: OceanicMaterial
...
let g:colors_name = 'OceanicMaterial'
set termguicolors

" Define colors
let s:none = 'NONE'
let s:bg_solid = '#1c262b'
let s:bg = get(g:, 'kitty_themes_transparent', 0) ? s:none : s:bg_solid
let s:fg = '#c1c8d6'
let s:cursor = '#b2b8c3'
let s:selection = '#6dc1b8'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#ee2a29')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#fee92e')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#1d80ef')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#16aec9')
...
let s:color8 = '#767676'
let s:color9 = '#dc5b60'
let s:color10 = '#70be71'
let s:color11 = '#fef063'
let s:color12 = '#53a4f3'
let s:color13 = '#a94dbb'
let s:color14 = '#42c6d9'
let s:color15 = '#fffefe'
