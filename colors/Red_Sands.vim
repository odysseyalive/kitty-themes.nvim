" Red_Sands colorscheme for Neovim
" Generated from kitty theme: Red_Sands
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'Red_Sands'
set termguicolors
" Define colors
let s:none = 'NONE'
let s:bg_solid = '#79241d'
...
let s:color8 = '#545454'
let s:color9 = '#ba0000'
let s:color10 = '#00ba00'
let s:color11 = '#e6af00'
let s:color12 = '#0071ae'
let s:color13 = '#ff54ff'
let s:color14 = '#54ffff'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#ff3e00')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#e6af00')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#0071ff')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#00baba')
