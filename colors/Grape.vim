" Grape colorscheme for Neovim
" Generated from kitty theme: Grape
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#ec2160')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#8ddc1f')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#487cf4')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#3added')
...
let s:color8 = '#58506a'
let s:color9 = '#f0719a'
let s:color10 = '#52a95d'
let s:color11 = '#b2dc87'
let s:color12 = '#a9bbeb'
let s:color13 = '#ac81c1'
let s:color14 = '#9ce3ea'
let s:color15 = '#a188f7'
