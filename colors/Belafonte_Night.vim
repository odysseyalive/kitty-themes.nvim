" Belafonte_Night colorscheme for Neovim
" Generated from kitty theme: Belafonte_Night
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'Belafonte_Night'
set termguicolors
" Define colors
let s:none = 'NONE'
let s:bg_solid = '#20111a'
...
let s:color8 = '#5e5252'
let s:color9 = '#bd100d'
let s:color10 = '#858062'
let s:color11 = '#e9a448'
let s:color12 = '#416978'
let s:color13 = '#96522b'
let s:color14 = '#98999c'
let s:color15 = '#d4ccb9'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#bd100d')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#e9a448')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#416978')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#98999c')
