" Floraverse colorscheme for Neovim
" Generated from kitty theme: Floraverse
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#331d4c'
let s:color9 = '#cf2062'
let s:color10 = '#b3ce58'
let s:color11 = '#fac357'
let s:color12 = '#40a4cf'
let s:color13 = '#f02aae'
let s:color14 = '#62caa8'
let s:color15 = '#fff5db'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#64002c')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#cd751c')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#1d6da1')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#42a38c')
