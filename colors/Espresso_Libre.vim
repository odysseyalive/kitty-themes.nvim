...
" Generated from kitty theme: Espresso_Libre
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'Espresso_Libre'
set termguicolors
" Define colors
let s:none = 'NONE'
let s:bg_solid = '#2a211c'
let s:bg = get(g:, 'kitty_themes_transparent', 0) ? s:none : s:bg_solid
let s:fg = '#b8a898'
let s:cursor = '#ffffff'
let s:selection = '#c3dcff'
...
let s:color8 = '#545753'
let s:color9 = '#ef2828'
let s:color10 = '#9aff87'
let s:color11 = '#fffa5c'
let s:color12 = '#43a8ed'
let s:color13 = '#ff8089'
...
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#efe43a')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#0066ff')
