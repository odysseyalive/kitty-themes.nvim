" Ciapre colorscheme for Neovim
" Generated from kitty theme: Ciapre
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#800009')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#cc8a3e')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#566d8c')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#5b4f4a')
...
let s:color8 = '#555555'
let s:color9 = '#ab3834'
let s:color10 = '#a6a65d'
let s:color11 = '#dcde7b'
let s:color12 = '#2f97c6'
let s:color13 = '#d33060'
let s:color14 = '#f3dab1'
