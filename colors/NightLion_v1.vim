" NightLion_v1 colorscheme for Neovim
" Generated from kitty theme: NightLion_v1
...
let g:colors_name = 'NightLion_v1'
set termguicolors
...
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#266ad7')
