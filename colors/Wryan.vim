" Wryan colorscheme for Neovim
" Generated from kitty theme: Wryan
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#3d3d3d'
let s:color9 = '#bf4d80'
let s:color10 = '#53a6a6'
let s:color11 = '#9e9ecb'
let s:color12 = '#477ab3'
let s:color13 = '#7e62b3'
let s:color14 = '#6096bf'
let s:color15 = '#c0c0c0'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#8c4665')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#7c7c99')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#395573')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#31658c')
