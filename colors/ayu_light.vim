" ayu_light colorscheme for Neovim
" Generated from kitty theme: ayu_light
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'ayu_light'
set termguicolors
" Define colors
let s:none = 'NONE'
let s:bg_solid = '#fafafa'
...
let s:color8 = '#323232'
let s:color9 = '#ff6565'
let s:color10 = '#b8e532'
let s:color11 = '#ffc849'
let s:color12 = '#73d7ff'
let s:color13 = '#ffa3aa'
let s:color14 = '#7ff0cb'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#ff3333')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#f19618')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#41a6d9')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#4cbe99')
