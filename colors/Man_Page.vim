" Man_Page colorscheme for Neovim
" Generated from kitty theme: Man_Page
...
let g:colors_name = 'Man_Page'
set termguicolors

" Define colors
let s:none = 'NONE'
let s:bg_solid = '#fef49c'
let s:bg = get(g:, 'kitty_themes_transparent', 0) ? s:none : s:bg_solid
let s:fg = '#000000'
let s:cursor = '#7f7f7f'
let s:selection = '#a4c9cd'
