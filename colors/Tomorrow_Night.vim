" Tomorrow_Night colorscheme for Neovim
" Generated from kitty theme: Tomorrow_Night
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#cc6666')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#f0c574')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#80a1bd')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#8abdb6')
...
let s:color11 = '#f0c574'
let s:color12 = '#80a1bd'
let s:color13 = '#b294ba'
let s:color14 = '#8abdb6'
