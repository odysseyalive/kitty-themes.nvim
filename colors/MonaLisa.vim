" MonaLisa colorscheme for Neovim
" Generated from kitty theme: MonaLisa
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#874227'
let s:color9 = '#ff4230'
let s:color10 = '#b3b163'
let s:color11 = '#ff9565'
let s:color12 = '#9eb2b3'
let s:color13 = '#ff5b6a'
let s:color14 = '#89cc8e'
let s:color15 = '#ffe597'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#9b281b')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#c26e27')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#515b5c')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#588056')
