" Seafoam_Pastel colorscheme for Neovim
" Generated from kitty theme: Seafoam_Pastel
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'Seafoam_Pastel'
set termguicolors
" Define colors
let s:none = 'NONE'
let s:bg_solid = '#243335'
...
let s:color8 = '#8a8a8a'
let s:color9 = '#cf9279'
let s:color10 = '#98d9aa'
let s:color11 = '#fae69c'
let s:color12 = '#79c3cf'
let s:color13 = '#d6b2a0'
let s:color14 = '#acdfdf'
let s:color15 = '#dfdfdf'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#825d4c')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#aca06d')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#4c7b82')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#719494')
