" Chalkboard colorscheme for Neovim
" Generated from kitty theme: Chalkboard
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#323232'
let s:color9 = '#dbaaaa'
let s:color10 = '#aadbaa'
let s:color11 = '#dadbaa'
let s:color12 = '#aaaadb'
let s:color13 = '#dbaada'
let s:color14 = '#aadadb'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#c37372')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#c2c372')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#7372c3')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#72c2c3')
