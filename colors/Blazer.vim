" Blazer colorscheme for Neovim
" Generated from kitty theme: Blazer
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#b87979')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#b8b879')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#7979b8')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#79b8b8')
...
let s:color8 = '#252525'
let s:color9 = '#dabdbd'
let s:color10 = '#bddabd'
let s:color11 = '#dadabd'
let s:color12 = '#bdbdda'
let s:color13 = '#dabdda'
let s:color14 = '#bddada'
