...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#ff2b2b')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#f0e68c')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#cd853f')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#ffa0a0')
