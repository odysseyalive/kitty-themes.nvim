" VibrantInk colorscheme for Neovim
" Generated from kitty theme: VibrantInk
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#ff6600')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#ffcc00')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#44b3cc')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#44b3cc')
