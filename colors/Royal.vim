" Royal colorscheme for Neovim
" Generated from kitty theme: Royal
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#312d3c'
let s:color9 = '#d4346c'
let s:color10 = '#2cd845'
let s:color11 = '#fde83a'
let s:color12 = '#8fb9f9'
let s:color13 = '#a479e2'
let s:color14 = '#abd3eb'
let s:color15 = '#9d8bbd'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#90274b')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#b49d27')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#6480af')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#8aaabd')
