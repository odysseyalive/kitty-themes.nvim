" Harper colorscheme for Neovim
" Generated from kitty theme: Harper
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#716d69'
let s:color9 = '#f7b63e'
let s:color10 = '#7fb5e1'
let s:color11 = '#d6da24'
let s:color12 = '#489d48'
let s:color13 = '#b295c5'
let s:color14 = '#f4bed6'
let s:color15 = '#fefbe9'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#f7b63e')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#d6da24')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#489d48')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#f4bed6')
