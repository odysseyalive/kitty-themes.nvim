" Earthsong colorscheme for Neovim
" Generated from kitty theme: Earthsong
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#665e54'
let s:color9 = '#ff6459'
let s:color10 = '#97e035'
let s:color11 = '#dfd561'
let s:color12 = '#5ed9ff'
let s:color13 = '#ff9168'
let s:color14 = '#83ef88'
let s:color15 = '#f6f6ec'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#c84134')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#f4ae2e')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#1397b9')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#4f9452')
