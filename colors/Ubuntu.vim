" Ubuntu colorscheme for Neovim
" Generated from kitty theme: Ubuntu
...
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#3465a4')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#06989a')
...
let s:color11 = '#fce94f'
let s:color12 = '#729fcf'
let s:color13 = '#ad7fa8'
let s:color14 = '#34e2e2'
let s:color15 = '#eeeeec'
