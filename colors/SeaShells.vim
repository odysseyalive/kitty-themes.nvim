" SeaShells colorscheme for Neovim
" Generated from kitty theme: SeaShells
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color11 = '#fdd29e'
let s:color12 = '#1abcdd'
let s:color13 = '#bbe3ee'
let s:color14 = '#86abb3'
let s:color15 = '#fee3cd'
...
call s:hi('TabLine', s:color8, s:color0, 'NONE')
call s:hi('TabLineFill', s:color8, s:color0, 'NONE')
call s:hi('TabLineSel', s:color15, s:color6, 'bold')
" bufferline.nvim plugin support
call s:hi('BufferLineTab', s:color8, s:color0, 'NONE')
call s:hi('BufferLineTabSelected', s:color15, s:color6, 'bold')
