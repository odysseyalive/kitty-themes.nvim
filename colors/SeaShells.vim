...
" bufferline.nvim support (LazyVim)
call s:hi('BufferLineBufferSelected', s:color11, s:color0, 'bold,italic')
...
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#2d6870')
