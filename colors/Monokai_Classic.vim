" Monokai_Classic colorscheme for Neovim
" Generated from kitty theme: Monokai_Classic
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'Monokai_Classic'
set termguicolors
" Define colors
let s:none = 'NONE'
let s:bg_solid = '#3b3c35'
...
let s:color8 = '#6e7066'
let s:color9 = '#f82570'
let s:color10 = '#a6e12d'
let s:color11 = '#e4db73'
let s:color12 = '#fc961f'
let s:color13 = '#ae81ff'
let s:color14 = '#66d9ee'
let s:color15 = '#fdfff1'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#f82570')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#e4db73')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#fc961f')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#66d9ee')
