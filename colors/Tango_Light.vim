" Tango_Light colorscheme for Neovim
" Generated from kitty theme: Tango_Light
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'Tango_Light'
set termguicolors
" Define colors
let s:none = 'NONE'
...
let s:color8 = '#545753'
let s:color9 = '#ef2828'
let s:color10 = '#8ae234'
let s:color11 = '#fce94e'
let s:color12 = '#719ecf'
let s:color13 = '#ad7ea7'
let s:color14 = '#34e2e2'
let s:color15 = '#ededec'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#cc0000')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#c4a000')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#3464a4')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#05989a')
