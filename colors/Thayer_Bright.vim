" Thayer_Bright colorscheme for Neovim
" Generated from kitty theme: Thayer_Bright
...
let g:colors_name = 'Thayer_Bright'
set termguicolors

" Define colors
let s:none = 'NONE'
let s:bg_solid = '#1b1d1e'
let s:bg = get(g:, 'kitty_themes_transparent', 0) ? s:none : s:bg_solid
let s:fg = '#f8f8f8'
let s:cursor = '#fc971e'
let s:selection = '#4d4d4d'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#f92672')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#f3fd21')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#2656d6')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#37c8b4')
...
let s:color8 = '#505354'
let s:color9 = '#ff5995'
let s:color10 = '#b6e354'
let s:color11 = '#feed6c'
let s:color12 = '#3f78ff'
let s:color13 = '#9e6ffe'
let s:color14 = '#23ced4'
let s:color15 = '#f8f8f2'
