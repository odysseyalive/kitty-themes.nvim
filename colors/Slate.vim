...
" Generated from kitty theme: Slate
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#e1a7bf')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#c4c9bf')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#254a49')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#14ab9c')
...
let s:color8 = '#ffffff'
let s:color9 = '#ffccd8'
let s:color10 = '#bdffa8'
let s:color11 = '#d0cbc9'
let s:color12 = '#79afd2'
let s:color13 = '#c4a7d8'
let s:color14 = '#8bdee0'
let s:color15 = '#e0e0e0'
