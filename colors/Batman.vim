...
" Generated from kitty theme: Batman
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#505354'
let s:color9 = '#fff68d'
let s:color10 = '#fff27c'
let s:color11 = '#feed6c'
let s:color12 = '#909495'
let s:color13 = '#9a999d'
let s:color14 = '#a2a2a5'
let s:color15 = '#dadad5'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#e6db43')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#f3fd21')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#737074')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#615f5e')
