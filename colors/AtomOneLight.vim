" AtomOneLight colorscheme for Neovim
" Generated from kitty theme: AtomOneLight
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#de3d35')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#d2b67b')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#2f5af3')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#3e953a')
...
let s:color8 = '#000000'
let s:color9 = '#de3d35'
let s:color10 = '#3e953a'
let s:color11 = '#d2b67b'
let s:color12 = '#2f5af3'
let s:color13 = '#a00095'
let s:color14 = '#3e953a'
