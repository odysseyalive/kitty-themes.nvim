" Brogrammer colorscheme for Neovim
" Generated from kitty theme: Brogrammer
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#f71118')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#ecb90f')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#2a84d2')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#0f80d5')
...
let s:color8 = '#d6dae4'
let s:color9 = '#de342e'
let s:color10 = '#1dd260'
let s:color11 = '#f2bd09'
let s:color12 = '#0f80d5'
let s:color13 = '#524fb9'
let s:color14 = '#0f7cda'
