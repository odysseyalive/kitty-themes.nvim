" DimmedMonokai colorscheme for Neovim
" Generated from kitty theme: DimmedMonokai
...
let g:colors_name = 'DimmedMonokai'
set termguicolors

" Define colors
let s:none = 'NONE'
let s:bg_solid = '#1e1e1e'
let s:bg = get(g:, 'kitty_themes_transparent', 0) ? s:none : s:bg_solid
let s:fg = '#b8bcb9'
let s:cursor = '#f83d19'
let s:selection = '#292c31'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#be3e48')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#c4a535')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#4e76a1')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#568ea3')
...
let s:color8 = '#888987'
let s:color9 = '#fb001e'
let s:color10 = '#0e712e'
let s:color11 = '#c37033'
let s:color12 = '#176ce3'
let s:color13 = '#fb0067'
let s:color14 = '#2d6f6c'
let s:color15 = '#fcffb8'
