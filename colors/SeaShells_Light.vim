" SeaShells_Light colorscheme for Neovim
" Light version of SeaShells theme with compatible color palette
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'SeaShells_Light'
set termguicolors
" Define colors
let s:none = 'NONE'
...
let s:ui_light = '#dcd4c8'    " Very light for status bar - barely darker than bg
let s:cursorline = '#d2cabe'  " Slightly darker for cursor line - more visible
...
call s:hi('CursorColumn', s:none, s:cursorline, s:none)
