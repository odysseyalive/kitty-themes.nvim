" GoaBase colorscheme for Neovim
" Generated from kitty theme: GoaBase
...
let g:colors_name = 'GoaBase'
set termguicolors

" Define colors
let s:none = 'NONE'
let s:bg_solid = '#2f0033'
let s:bg = get(g:, 'kitty_themes_transparent', 0) ? s:none : s:bg_solid
let s:fg = '#f6ed00'
let s:cursor = '#1a6500'
let s:selection = '#100a24'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#f78000')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#f40000')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#000482')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#3affff')
...
let s:color8 = '#411a6d'
let s:color9 = '#f800e1'
let s:color10 = '#5743ff'
let s:color11 = '#ea00d7'
let s:color12 = '#b90003'
