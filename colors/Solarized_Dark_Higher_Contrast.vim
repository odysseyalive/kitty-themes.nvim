" Solarized_Dark_Higher_Contrast colorscheme for Neovim
" Generated from kitty theme: Solarized_Dark_Higher_Contrast
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'Solarized_Dark_Higher_Contrast'
set termguicolors
" Define colors
let s:none = 'NONE'
let s:bg_solid = '#001e26'
...
let s:color8 = '#006388'
let s:color9 = '#f4153b'
let s:color10 = '#50ee84'
let s:color11 = '#b17e28'
let s:color12 = '#178dc7'
let s:color13 = '#e14d8e'
let s:color14 = '#00b29e'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#d01b24')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#a57705')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#2075c7')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#259185')
