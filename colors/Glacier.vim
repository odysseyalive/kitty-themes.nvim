" Glacier colorscheme for Neovim
" Generated from kitty theme: Glacier
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#404a55'
let s:color9 = '#bd0f2f'
let s:color10 = '#49e998'
let s:color11 = '#fddf6e'
let s:color12 = '#2a8bc1'
let s:color13 = '#ea4727'
let s:color14 = '#a0b6d3'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#bd0f2f')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#fb9435')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#1f5872')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#778397')
