" Renault_Style colorscheme for Neovim
" Generated from kitty theme: Renault_Style
...
let g:colors_name = 'Renault_Style'
set termguicolors

" Define colors
let s:none = 'NONE'
let s:bg_solid = '#3a3a3a'
let s:bg = get(g:, 'kitty_themes_transparent', 0) ? s:none : s:bg_solid
let s:fg = '#e9cb7b'
let s:cursor = '#7f7f7f'
let s:selection = '#958553'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#990000')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#999900')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#0000B2')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#00A6B2')
...
let s:color8 = '#666666'
let s:color9 = '#E50000'
let s:color10 = '#00d800'
let s:color11 = '#E5E500'
let s:color12 = '#0000FF'
let s:color13 = '#E500E5'
let s:color14 = '#00e5e5'
