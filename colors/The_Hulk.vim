" The_Hulk colorscheme for Neovim
" Generated from kitty theme: The_Hulk
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'The_Hulk'
set termguicolors
" Define colors
let s:none = 'NONE'
...
let s:color8 = '#505354'
let s:color9 = '#8dff2a'
let s:color10 = '#48ff76'
let s:color11 = '#3afe15'
let s:color12 = '#4f6a95'
let s:color13 = '#72579d'
let s:color14 = '#3f85a5'
let s:color15 = '#e5e5e0'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#259d1a')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#62e456')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#2424f4')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#378ca9')
