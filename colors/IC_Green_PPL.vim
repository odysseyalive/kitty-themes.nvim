" IC_Green_PPL colorscheme for Neovim
" Generated from kitty theme: IC_Green_PPL
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'IC_Green_PPL'
set termguicolors
" Define colors
let s:none = 'NONE'
let s:bg_solid = '#3a3c3e'
let s:bg = get(g:, 'kitty_themes_transparent', 0) ? s:none : s:bg_solid
let s:fg = '#d9eed2'
let s:cursor = '#41ff58'
let s:selection = '#2a9b34'
...
let s:color8 = '#03260f'
let s:color9 = '#a6ff3e'
let s:color10 = '#9fff6d'
let s:color11 = '#d1ff6d'
let s:color12 = '#72ffb5'
let s:color13 = '#50ff3d'
let s:color14 = '#22ff71'
let s:color15 = '#daeed0'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#fb0029')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#649a25')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#149b45')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#2bb767')
