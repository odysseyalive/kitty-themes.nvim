" Tomorrow_Night_Eighties colorscheme for Neovim
" Generated from kitty theme: Tomorrow_Night_Eighties
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#000000'
let s:color9 = '#f17779'
let s:color10 = '#99cc99'
let s:color11 = '#ffcc66'
let s:color12 = '#6699cc'
let s:color13 = '#cc99cc'
let s:color14 = '#66cccc'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#f17779')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#ffcc66')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#6699cc')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#66cccc')
