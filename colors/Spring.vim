" Spring colorscheme for Neovim
" Generated from kitty theme: Spring
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#000000'
let s:color9 = '#ff0021'
let s:color10 = '#1fc231'
let s:color11 = '#d4b706'
let s:color12 = '#15a9fd'
let s:color13 = '#8959a8'
let s:color14 = '#3e999f'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#ff4c83')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#1fc95a')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#1cd2ee')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#3e999f')
