" Flatland colorscheme for Neovim
" Generated from kitty theme: Flatland
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#1c1d19'
let s:color9 = '#d12a24'
let s:color10 = '#a7d32c'
let s:color11 = '#ff8948'
let s:color12 = '#61b8d0'
let s:color13 = '#695abb'
let s:color14 = '#d53864'
let s:color15 = '#fefffe'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#f18238')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#f3ef6d')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#4f96be')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#d53864')
