...
" Generated from kitty theme: Zenburn
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#709080'
let s:color9 = '#dca3a3'
let s:color10 = '#c3bf9f'
let s:color11 = '#dfcf9f'
let s:color12 = '#94bff3'
...
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#f0deae')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#506070')
