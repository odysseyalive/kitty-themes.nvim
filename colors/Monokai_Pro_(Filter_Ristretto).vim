" Monokai_Pro_(Filter_Ristretto) colorscheme for Neovim
" Generated from kitty theme: Monokai_Pro_(Filter_Ristretto)
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'Monokai_Pro_(Filter_Ristretto)'
set termguicolors
" Define colors
let s:none = 'NONE'
let s:bg_solid = '#403838'
let s:bg = get(g:, 'kitty_themes_transparent', 0) ? s:none : s:bg_solid
let s:fg = '#fff1f3'
let s:cursor = '#fff1f3'
let s:selection = '#fff1f3'
...
let s:color8 = '#72696a'
let s:color9 = '#fd6883'
let s:color10 = '#adda78'
let s:color11 = '#f9cc6c'
let s:color12 = '#f38d70'
let s:color13 = '#a8a9eb'
let s:color14 = '#85dacc'
let s:color15 = '#fff1f3'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#fd6883')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#f9cc6c')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#f38d70')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#85dacc')
