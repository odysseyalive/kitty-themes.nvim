...
" Generated from kitty theme: Nova
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#efc08d')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#d7d690')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#83afe4')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#7fc1b6')
...
let s:color8 = '#c4d3dc'
let s:color9 = '#ef8358'
let s:color10 = '#a8ce93'
let s:color11 = '#e5e77f'
let s:color12 = '#69c8ff'
let s:color13 = '#d18ec2'
let s:color14 = '#00e59f'
let s:color15 = '#e6eef3'
