" Hipster_Green colorscheme for Neovim
" Generated from kitty theme: Hipster_Green
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'Hipster_Green'
set termguicolors
" Define colors
let s:none = 'NONE'
let s:bg_solid = '#0f0a05'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#b6204a')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#bebe00')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#246db2')
