" Pnevma colorscheme for Neovim
" Generated from kitty theme: Pnevma
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#4a4845'
let s:color9 = '#d78787'
let s:color10 = '#afbea2'
let s:color11 = '#e4c9af'
let s:color12 = '#a1bdce'
let s:color13 = '#d7beda'
let s:color14 = '#b1e7dd'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#a36666')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#d7af87')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#7fa5bd')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#8adbb4')
