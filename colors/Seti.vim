" Seti colorscheme for Neovim
" Generated from kitty theme: Seti
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#c22832')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#e0c64f')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#43a5d5')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#8ec43d')
...
let s:color8 = '#323232'
let s:color9 = '#c22832'
let s:color10 = '#8ec43d'
let s:color11 = '#e0c64f'
let s:color12 = '#43a5d5'
let s:color13 = '#8b57b5'
let s:color14 = '#8ec43d'
