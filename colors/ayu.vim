" ayu colorscheme for Neovim
" Generated from kitty theme: ayu
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#323232'
let s:color9 = '#ff6565'
let s:color10 = '#e9fe83'
let s:color11 = '#fff778'
let s:color12 = '#68d4ff'
let s:color13 = '#ffa3aa'
let s:color14 = '#c7fffc'
...
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#36a3d9')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#95e5cb')
