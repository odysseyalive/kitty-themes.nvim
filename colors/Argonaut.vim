" Argonaut colorscheme for Neovim
" Generated from kitty theme: Argonaut
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#444444'
let s:color9 = '#ff273f'
let s:color10 = '#abe05a'
let s:color11 = '#ffd141'
let s:color12 = '#0092ff'
let s:color13 = '#9a5feb'
let s:color14 = '#67ffef'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#ff000f')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#ffb900')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#008df8')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#00d7eb')
