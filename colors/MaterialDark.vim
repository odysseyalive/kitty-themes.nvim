" MaterialDark colorscheme for Neovim
" Generated from kitty theme: MaterialDark
...
let g:colors_name = 'MaterialDark'
set termguicolors

" Define colors
let s:none = 'NONE'
let s:bg_solid = '#222221'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#b7141e')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#f5971d')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#134eb2')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#0e707c')
...
let s:color8 = '#424242'
let s:color9 = '#e83a3f'
let s:color10 = '#7aba39'
let s:color11 = '#fee92e'
let s:color12 = '#53a4f3'
let s:color13 = '#a94dbb'
let s:color14 = '#26bad1'
let s:color15 = '#d8d8d8'
