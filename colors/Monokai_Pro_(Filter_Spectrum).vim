...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#fc618d')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#fce566')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#fd9353')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#5ad4e6')
