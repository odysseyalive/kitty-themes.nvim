...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#c84821')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#c08a2f')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#3d8ed0')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#21a1c8')
