" Smyck colorscheme for Neovim
" Generated from kitty theme: Smyck
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#7a7a7a'
let s:color9 = '#d6837b'
let s:color10 = '#c4f036'
let s:color11 = '#fee14d'
let s:color12 = '#8dcff0'
let s:color13 = '#f799ff'
let s:color14 = '#69d9cf'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#b74131')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#c4a400')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#62a3c4')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#207383')
