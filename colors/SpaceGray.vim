" SpaceGray colorscheme for Neovim
" Generated from kitty theme: SpaceGray
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#000000'
let s:color9 = '#af4b57'
let s:color10 = '#87b279'
let s:color11 = '#e5c078'
let s:color12 = '#7c8fa3'
let s:color13 = '#a37996'
let s:color14 = '#84a6a4'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#af4b57')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#e5c078')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#7c8fa3')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#84a6a4')
