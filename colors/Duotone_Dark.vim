" Duotone_Dark colorscheme for Neovim
" Generated from kitty theme: Duotone_Dark
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'Duotone_Dark'
set termguicolors
" Define colors
let s:none = 'NONE'
let s:bg_solid = '#1f1c27'
...
let s:color8 = '#353146'
let s:color9 = '#d8393d'
let s:color10 = '#2dcc72'
let s:color11 = '#d8b76e'
let s:color12 = '#ffc183'
let s:color13 = '#dd8d40'
let s:color14 = '#2388ff'
let s:color15 = '#e9e4ff'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#d8393d')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#d8b76e')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#ffc183')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#2388ff')
