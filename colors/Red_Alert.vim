" Red_Alert colorscheme for Neovim
" Generated from kitty theme: Red_Alert
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#262626'
let s:color9 = '#e02453'
let s:color10 = '#aff08b'
let s:color11 = '#dfddb7'
let s:color12 = '#65a9f0'
let s:color13 = '#ddb7df'
let s:color14 = '#b7dfdd'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#d52e4d')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#beb86b')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#479bed')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#6bbeb8')
