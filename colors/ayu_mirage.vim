" ayu_mirage colorscheme for Neovim
" Generated from kitty theme: ayu_mirage
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'ayu_mirage'
set termguicolors
" Define colors
let s:none = 'NONE'
let s:bg_solid = '#212733'
...
let s:color8 = '#686868'
let s:color9 = '#f28779'
let s:color10 = '#bae67e'
let s:color11 = '#ffd580'
let s:color12 = '#73d0ff'
let s:color13 = '#d4bfff'
let s:color14 = '#95e6cb'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#ed8274')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#fad07b')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#6dcbfa')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#90e1c6')
