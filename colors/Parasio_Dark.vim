" Parasio_Dark colorscheme for Neovim
" Generated from kitty theme: Parasio_Dark
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'Parasio_Dark'
set termguicolors
" Define colors
let s:none = 'NONE'
let s:bg_solid = '#2f1d2e'
...
let s:color8 = '#776d70'
let s:color9 = '#ef6154'
let s:color10 = '#48b685'
let s:color11 = '#fec418'
let s:color12 = '#05b6ef'
let s:color13 = '#805ba3'
let s:color14 = '#5bc4be'
let s:color15 = '#e6e9da'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#ef6154')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#fec418')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#05b6ef')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#5bc4be')
