" Alucard colorscheme for Neovim
" Generated from kitty theme: Alucard
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#545454'
let s:color9 = '#ff5454'
let s:color10 = '#50fa7b'
let s:color11 = '#f0fa8b'
let s:color12 = '#1200f8'
let s:color13 = '#ff78c5'
let s:color14 = '#8ae9fc'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#ff5555')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#7f0a1f')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#3282ff')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#0037fc')
