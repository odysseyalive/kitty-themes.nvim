" Later_This_Evening colorscheme for Neovim
" Generated from kitty theme: Later_This_Evening
...
let g:colors_name = 'Later_This_Evening'
set termguicolors
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#d35a5f')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#e5d289')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#a0b9d5')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#91beb6')
...
let s:color8 = '#444747'
let s:color9 = '#d3222e'
let s:color10 = '#aabb39'
let s:color11 = '#e4bd39'
let s:color12 = '#6599d5'
let s:color13 = '#aa52d5'
let s:color14 = '#5fbfad'
let s:color15 = '#c0c2c2'
