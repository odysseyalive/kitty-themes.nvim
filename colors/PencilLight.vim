" PencilLight colorscheme for Neovim
" Generated from kitty theme: PencilLight
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'PencilLight'
set termguicolors
" Define colors
let s:none = 'NONE'
let s:bg_solid = '#f0f0f0'
let s:bg = get(g:, 'kitty_themes_transparent', 0) ? s:none : s:bg_solid
let s:fg = '#414141'
let s:cursor = '#20bafb'
let s:selection = '#b6d6fc'
...
let s:color8 = '#414141'
let s:color9 = '#fb0079'
let s:color10 = '#5ed6ae'
let s:color11 = '#f3e42f'
let s:color12 = '#20bafb'
let s:color13 = '#6854de'
let s:color14 = '#4fb8cc'
let s:color15 = '#f0f0f0'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#c30670')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#a79c14')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#008ec4')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#20a4b9')
