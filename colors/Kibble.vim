" Kibble colorscheme for Neovim
" Generated from kitty theme: Kibble
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#c70031')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#d8e30e')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#3449d1')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#0798ab')
...
let s:color8 = '#5a5a5a'
let s:color9 = '#f01578'
let s:color10 = '#6ce05c'
let s:color11 = '#f3f79e'
let s:color12 = '#97a4f7'
let s:color13 = '#c495f0'
let s:color14 = '#68f2e0'
