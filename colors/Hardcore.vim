" Hardcore colorscheme for Neovim
" Generated from kitty theme: Hardcore
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#505354'
let s:color9 = '#ff669d'
let s:color10 = '#beed5f'
let s:color11 = '#e6db74'
let s:color12 = '#66d9ef'
let s:color13 = '#9e6ffe'
let s:color14 = '#a3babf'
...
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#fd971f')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#66d9ef')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#5e7175')
