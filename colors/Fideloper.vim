" Fideloper colorscheme for Neovim
" Generated from kitty theme: Fideloper
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#092027'
let s:color9 = '#d35f5a'
let s:color10 = '#d35f5a'
let s:color11 = '#a86571'
let s:color12 = '#7c84c4'
let s:color13 = '#5b5db2'
let s:color14 = '#81908f'
let s:color15 = '#fcf4de'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#ca1d2c')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#b7aa9a')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#2e78c1')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#309185')
