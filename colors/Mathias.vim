" Mathias colorscheme for Neovim
" Generated from kitty theme: Mathias
hi clear
if exists('syntax_on')
  syntax reset
endif
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#e52222')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#fc951e')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#c48dff')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#67d9f0')
