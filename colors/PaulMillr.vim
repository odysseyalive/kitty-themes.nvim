" PaulMillr colorscheme for Neovim
" Generated from kitty theme: PaulMillr
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'PaulMillr'
set termguicolors
" Define colors
let s:none = 'NONE'
...
let s:color8 = '#666666'
let s:color9 = '#ff007f'
let s:color10 = '#66ff66'
let s:color11 = '#f3d64d'
let s:color12 = '#7099ec'
let s:color13 = '#da66e5'
let s:color14 = '#79def1'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#ff0000')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#e6be00')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#396ad6')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#66ccff')
