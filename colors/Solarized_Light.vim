" Solarized_Light colorscheme for Neovim
" Generated from kitty theme: Solarized_Light
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#ffffd7'
let s:color9 = '#d75f00'
let s:color10 = '#585858'
let s:color11 = '#626262'
let s:color12 = '#808080'
let s:color13 = '#5f5faf'
let s:color14 = '#8a8a8a'
let s:color15 = '#1c1c1c'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#d70000')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#af8700')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#0087ff')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#00afaf')
