" Lavandula colorscheme for Neovim
" Generated from kitty theme: Lavandula
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#362c45'
let s:color9 = '#df5066'
let s:color10 = '#52e0c4'
let s:color11 = '#e0c286'
let s:color12 = '#8e86df'
let s:color13 = '#a675df'
let s:color14 = '#9ad3df'
let s:color15 = '#8b91fa'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#7c1525')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#7f6f49')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#4f4a7f')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#57767f')
