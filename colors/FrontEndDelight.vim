" FrontEndDelight colorscheme for Neovim
" Generated from kitty theme: FrontEndDelight
...
let g:colors_name = 'FrontEndDelight'
set termguicolors

" Define colors
let s:none = 'NONE'
let s:bg_solid = '#1b1b1d'
let s:bg = get(g:, 'kitty_themes_transparent', 0) ? s:none : s:bg_solid
let s:fg = '#acacac'
let s:cursor = '#cccccc'
let s:selection = '#e96153'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#f8501a')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#f9761d')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#2c70b7')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#3ba0a5')
...
let s:color8 = '#5eac6c'
let s:color9 = '#f64319'
let s:color10 = '#74eb4c'
let s:color11 = '#fcc224'
let s:color12 = '#3393c9'
let s:color13 = '#e75e4e'
let s:color14 = '#4ebce5'
let s:color15 = '#8b735a'
