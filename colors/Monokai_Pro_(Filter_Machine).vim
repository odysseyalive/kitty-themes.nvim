" Monokai_Pro_(Filter_Machine) colorscheme for Neovim
" Generated from kitty theme: Monokai_Pro_(Filter_Machine)
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'Monokai_Pro_(Filter_Machine)'
set termguicolors
" Define colors
let s:none = 'NONE'
let s:bg_solid = '#3a4449'
let s:bg = get(g:, 'kitty_themes_transparent', 0) ? s:none : s:bg_solid
let s:fg = '#f2fffc'
let s:cursor = '#f2fffc'
let s:selection = '#f2fffc'
...
let s:color8 = '#6b7678'
let s:color9 = '#ff6d7e'
let s:color10 = '#a2e57b'
let s:color11 = '#ffed72'
let s:color12 = '#ffb270'
let s:color13 = '#baa0f8'
let s:color14 = '#7cd5f1'
let s:color15 = '#f2fffc'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#ff6d7e')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#ffed72')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#ffb270')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#7cd5f1')
