" JetBrains_Darcula colorscheme for Neovim
" Generated from kitty theme: JetBrains_Darcula
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'JetBrains_Darcula'
set termguicolors
" Define colors
let s:none = 'NONE'
let s:bg_solid = '#202020'
let s:bg = get(g:, 'kitty_themes_transparent', 0) ? s:none : s:bg_solid
let s:fg = '#adadad'
let s:cursor = '#ffffff'
let s:selection = '#1a3272'
...
let s:color8 = '#545454'
let s:color9 = '#fb7172'
let s:color10 = '#67ff4f'
let s:color11 = '#ffff00'
let s:color12 = '#6d9df1'
let s:color13 = '#fb82ff'
let s:color14 = '#60d3d1'
let s:color15 = '#eeeeee'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#fa5355')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#c2c300')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#4581eb')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#33c2c1')
