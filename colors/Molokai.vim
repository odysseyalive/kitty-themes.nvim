...
" Generated from kitty theme: Molokai
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#fa2573')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#dfd460')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#0f7fcf')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#42a7cf')
...
let s:color8 = '#545454'
let s:color9 = '#f5669c'
let s:color10 = '#b0e05e'
let s:color11 = '#fef26c'
let s:color12 = '#00afff'
let s:color13 = '#af87ff'
let s:color14 = '#50cdfe'
