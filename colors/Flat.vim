" Flat colorscheme for Neovim
" Generated from kitty theme: Flat
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#202b3b'
let s:color9 = '#d3302e'
let s:color10 = '#2c9440'
let s:color11 = '#e5bd0c'
let s:color12 = '#3b7cd2'
let s:color13 = '#822fa7'
let s:color14 = '#35b286'
let s:color15 = '#e6ecec'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#a72320')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#e58d11')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#3066ab')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#2b9270')
