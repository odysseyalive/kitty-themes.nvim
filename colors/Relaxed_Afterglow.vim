" Relaxed_Afterglow colorscheme for Neovim
" Generated from kitty theme: Relaxed_Afterglow
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'Relaxed_Afterglow'
set termguicolors
" Define colors
let s:none = 'NONE'
let s:bg_solid = '#353a44'
let s:bg = get(g:, 'kitty_themes_transparent', 0) ? s:none : s:bg_solid
let s:fg = '#d9d9d9'
let s:cursor = '#d9d9d9'
let s:selection = '#6a7984'
...
let s:color8 = '#636363'
let s:color9 = '#bc5653'
let s:color10 = '#a0ac77'
let s:color11 = '#ebc17a'
let s:color12 = '#7eaac7'
let s:color13 = '#b06698'
let s:color14 = '#acbbd0'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#bc5653')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#ebc17a')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#6a8799')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#c9dfff')
