" FishTank colorscheme for Neovim
" Generated from kitty theme: FishTank
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'FishTank'
set termguicolors
" Define colors
let s:none = 'NONE'
let s:bg_solid = '#222436'
...
let s:color8 = '#6c5a30'
let s:color9 = '#d94a8a'
let s:color10 = '#daffa8'
let s:color11 = '#fee6a8'
let s:color12 = '#b1bdf9'
let s:color13 = '#fda4cc'
let s:color14 = '#a4bc86'
let s:color15 = '#f6ffec'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#c60049')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#fdcd5e')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#525fb8')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#968662')
