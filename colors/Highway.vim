" Highway colorscheme for Neovim
" Generated from kitty theme: Highway
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#5c4f49'
let s:color9 = '#ef7d17'
let s:color10 = '#b1d130'
let s:color11 = '#fff11f'
let s:color12 = '#4fc2fd'
let s:color13 = '#de0070'
let s:color14 = '#5c4f49'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#cf0d17')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#ffca3d')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#006ab3')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#384563')
