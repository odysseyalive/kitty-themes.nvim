" Square colorscheme for Neovim
" Generated from kitty theme: Square
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#e9897c')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#ecebbe')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#a9cdeb')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#c9caec')
...
let s:color8 = '#141414'
let s:color9 = '#f99286'
let s:color10 = '#c3f786'
let s:color11 = '#fcfbcc'
let s:color12 = '#b6defb'
let s:color13 = '#ad7fa8'
let s:color14 = '#d7d9fc'
let s:color15 = '#e2e2e2'
