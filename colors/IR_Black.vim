" IR_Black colorscheme for Neovim
" Generated from kitty theme: IR_Black
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color11 = '#fffecc'
let s:color12 = '#b5dcfe'
let s:color13 = '#fb9bfe'
let s:color14 = '#dfdffd'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#fa6c5f')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#fffeb6')
