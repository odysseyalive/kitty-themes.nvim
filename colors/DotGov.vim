" DotGov colorscheme for Neovim
" Generated from kitty theme: DotGov
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'DotGov'
set termguicolors
" Define colors
let s:none = 'NONE'
let s:bg_solid = '#252b35'
...
let s:color8 = '#181818'
let s:color9 = '#bf081d'
let s:color10 = '#3d9751'
let s:color11 = '#f6bb33'
let s:color12 = '#16b1df'
let s:color13 = '#772fb0'
let s:color14 = '#8bd1ed'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#bf081d')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#f6bb33')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#16b1df')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#8bd1ed')
