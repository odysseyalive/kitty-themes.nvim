" Obsidian colorscheme for Neovim
" Generated from kitty theme: Obsidian
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#545454'
let s:color9 = '#ff0003'
let s:color10 = '#92c763'
let s:color11 = '#fef773'
let s:color12 = '#a0d6ff'
let s:color13 = '#ff55ff'
let s:color14 = '#55ffff'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#a50001')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#fecc22')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#399bda')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#00bbbb')
