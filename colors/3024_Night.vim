" 3024_Night colorscheme for Neovim
" Generated from kitty theme: 3024_Night
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = '3024_Night'
set termguicolors
" Define colors
let s:none = 'NONE'
let s:bg_solid = '#090200'
...
let s:color8 = '#5b5754'
let s:color9 = '#e8bacf'
let s:color10 = '#3a3332'
let s:color11 = '#494542'
let s:color12 = '#7f7c7b'
let s:color13 = '#d6d4d3'
let s:color14 = '#ccab53'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#da2c20')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#fcec02')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#00a0e4')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#b5e4f4')
