" Espresso colorscheme for Neovim
" Generated from kitty theme: Espresso
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#535353'
let s:color9 = '#f00c0c'
let s:color10 = '#c1df74'
let s:color11 = '#e1e48a'
let s:color12 = '#8ab6d9'
let s:color13 = '#efb5f7'
let s:color14 = '#dbf4ff'
...
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#ffc56d')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#6c99ba')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#bdd6ff')
