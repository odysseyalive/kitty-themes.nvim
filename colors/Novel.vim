" Novel colorscheme for Neovim
" Generated from kitty theme: Novel
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#7f7f7f'
let s:color9 = '#cc0000'
let s:color10 = '#009600'
let s:color11 = '#d06b00'
let s:color12 = '#0000cc'
let s:color13 = '#cc00cc'
let s:color14 = '#0086cb'
...
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#d06b00')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#0000cc')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#0087cc')
