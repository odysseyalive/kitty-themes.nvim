" Dark_Pastel colorscheme for Neovim
" Generated from kitty theme: Dark_Pastel
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'Dark_Pastel'
set termguicolors
" Define colors
let s:none = 'NONE'
...
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#ffff55')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#5555ff')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#55ffff')
