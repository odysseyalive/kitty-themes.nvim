" Afterglow colorscheme for Neovim
" Generated from kitty theme: Afterglow
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#505050'
let s:color9 = '#ac4142'
let s:color10 = '#7e8d50'
let s:color11 = '#e5b566'
let s:color12 = '#6c99ba'
let s:color13 = '#9e4e85'
let s:color14 = '#7dd5cf'
let s:color15 = '#f5f5f5'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#ac4142')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#e5b566')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#6c99ba')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#7dd5cf')
