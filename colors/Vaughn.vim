" Vaughn colorscheme for Neovim
" Generated from kitty theme: Vaughn
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#709080'
let s:color9 = '#dca3a3'
let s:color10 = '#60b48a'
let s:color11 = '#f0dfaf'
let s:color12 = '#5454ff'
let s:color13 = '#ec93d3'
let s:color14 = '#93e0e3'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#705050')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#dfaf8f')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#5454ff')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#8cd0d3')
