" Source_Code_X colorscheme for Neovim
" Generated from kitty theme: Source_Code_X
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'Source_Code_X'
set termguicolors
" Define colors
let s:none = 'NONE'
let s:bg_solid = '#1f1f24'
...
let s:color8 = '#91a0b1'
let s:color9 = '#fb695d'
let s:color10 = '#aef37c'
let s:color11 = '#fc8e3e'
let s:color12 = '#53a4fb'
let s:color13 = '#fb5ea3'
let s:color14 = '#83d2c0'
let s:color15 = '#91a0b1'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#fb695d')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#fc8e3e')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#9586f4')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#79c8b6')
