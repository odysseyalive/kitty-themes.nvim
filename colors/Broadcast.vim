" Broadcast colorscheme for Neovim
" Generated from kitty theme: Broadcast
hi clear
if exists('syntax_on')
  syntax reset
endif
...
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#6d9cbd')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#6d9cbd')
