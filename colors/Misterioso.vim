" Misterioso colorscheme for Neovim
" Generated from kitty theme: Misterioso
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#545454'
let s:color9 = '#ff3241'
let s:color10 = '#74cc68'
let s:color11 = '#ffb928'
let s:color12 = '#23d6d6'
let s:color13 = '#ff37ff'
let s:color14 = '#00ece1'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#ff4141')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#ffac28')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#338e86')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#23d6d6')
