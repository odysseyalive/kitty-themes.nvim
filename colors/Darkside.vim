" Darkside colorscheme for Neovim
" Generated from kitty theme: Darkside
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#e8331c')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#f1d32b')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#1c98e8')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#1c98e8')
...
let s:color8 = '#000000'
let s:color9 = '#df5a4f'
let s:color10 = '#76b768'
let s:color11 = '#eed64a'
let s:color12 = '#387bd2'
let s:color13 = '#957bbd'
let s:color14 = '#3d96e2'
let s:color15 = '#b9b9b9'
