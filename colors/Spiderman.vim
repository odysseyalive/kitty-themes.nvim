" Spiderman colorscheme for Neovim
" Generated from kitty theme: Spiderman
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#505354'
let s:color9 = '#ff0325'
let s:color10 = '#ff3238'
let s:color11 = '#fe3935'
let s:color12 = '#1d4fff'
let s:color13 = '#737bff'
let s:color14 = '#6083ff'
let s:color15 = '#fefff9'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#e60712')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#e24655')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#2b3fff')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#3255ff')
