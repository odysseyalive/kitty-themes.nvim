" SpaceGray_Eighties_Dull colorscheme for Neovim
" Generated from kitty theme: SpaceGray_Eighties_Dull
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'SpaceGray_Eighties_Dull'
set termguicolors
" Define colors
let s:none = 'NONE'
let s:bg_solid = '#212121'
let s:bg = get(g:, 'kitty_themes_transparent', 0) ? s:none : s:bg_solid
let s:fg = '#c8c5bc'
let s:cursor = '#bbbbbb'
let s:selection = '#262e36'
...
let s:color8 = '#545454'
let s:color9 = '#ec5f67'
let s:color10 = '#88e985'
let s:color11 = '#fdc253'
let s:color12 = '#5485c0'
let s:color13 = '#bf83c0'
let s:color14 = '#58c2c0'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#b14956')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#c6725a')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#7b8fa4')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#7fcccb')
