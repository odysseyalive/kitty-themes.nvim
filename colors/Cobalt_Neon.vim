" Cobalt_Neon colorscheme for Neovim
" Generated from kitty theme: Cobalt_Neon
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'Cobalt_Neon'
set termguicolors
" Define colors
let s:none = 'NONE'
let s:bg_solid = '#142838'
...
let s:color8 = '#fff688'
let s:color9 = '#d4312e'
let s:color10 = '#8ff586'
let s:color11 = '#e9f06d'
let s:color12 = '#3c7dd2'
let s:color13 = '#8230a7'
let s:color14 = '#6cbc67'
let s:color15 = '#8ff586'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#ff2320')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#e9e75c')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#8ff586')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#8ff586')
