" Tomorrow_Night_Blue colorscheme for Neovim
" Generated from kitty theme: Tomorrow_Night_Blue
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#000000'
let s:color9 = '#ff9ca3'
let s:color10 = '#d0f0a8'
let s:color11 = '#ffedac'
let s:color12 = '#badaff'
let s:color13 = '#ebbaff'
let s:color14 = '#99ffff'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#ff9ca3')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#ffedac')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#badaff')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#99ffff')
