" Sundried colorscheme for Neovim
" Generated from kitty theme: Sundried
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#4d4d47'
let s:color9 = '#aa000c'
let s:color10 = '#128c20'
let s:color11 = '#fc6a20'
let s:color12 = '#7898f7'
let s:color13 = '#fc89a0'
let s:color14 = '#fad384'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#a6463d')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#9c5f2a')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#485a98')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#9c814e')
