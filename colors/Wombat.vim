" Wombat colorscheme for Neovim
" Generated from kitty theme: Wombat
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#313131'
let s:color9 = '#f58b7f'
let s:color10 = '#dcf88f'
let s:color11 = '#eee5b2'
let s:color12 = '#a5c7ff'
let s:color13 = '#ddaaff'
let s:color14 = '#b6fff9'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#ff605a')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#ead89c')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#5da9f6')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#82fff6')
