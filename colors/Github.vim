...
" Generated from kitty theme: Github
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#666666'
let s:color9 = '#de0000'
let s:color10 = '#87d5a2'
let s:color11 = '#f0cf06'
let s:color12 = '#2e6cba'
let s:color13 = '#ffa29f'
let s:color14 = '#1cfafe'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#970b16')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#f7edc7')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#003e8a')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#89d1ec')
