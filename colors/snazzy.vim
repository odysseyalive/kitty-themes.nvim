" snazzy colorscheme for Neovim
" Generated from kitty theme: snazzy
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#686868'
let s:color9 = '#FF5C57'
let s:color10 = '#5AF78E'
let s:color11 = '#F3F99D'
let s:color12 = '#57C7FF'
let s:color13 = '#FF6AC1'
let s:color14 = '#9AEDFE'
let s:color15 = '#EFF0EB'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#FF5C57')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#F3F99D')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#57C7FF')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#9AEDFE')
