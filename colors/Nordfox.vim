" Nordfox colorscheme for Neovim
" Generated from kitty theme: Nordfox
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#465780'
let s:color9 = '#d06f79'
let s:color10 = '#b1d196'
let s:color11 = '#f0d399'
let s:color12 = '#8cafd2'
let s:color13 = '#c895bf'
let s:color14 = '#93ccdc'
let s:color15 = '#e7ecf4'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#bf616a')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#ebcb8b')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#81a1c1')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#88c0d0')
