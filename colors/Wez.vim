" Wez colorscheme for Neovim
" Generated from kitty theme: Wez
hi clear
if exists('syntax_on')
  syntax reset
endif
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#cc5555')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#cdcd55')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#5455cb')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#7acaca')
