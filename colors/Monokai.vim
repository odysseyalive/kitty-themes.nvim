...
" Generated from kitty theme: Monokai
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#75715e'
let s:color9 = '#f92672'
let s:color10 = '#a6e22e'
let s:color11 = '#e6db74'
let s:color12 = '#66d9ef'
let s:color13 = '#fd971f'
let s:color14 = '#ae81ff'
...
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#e6db74')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#66d9ef')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#ae81ff')
