" 1984_dark colorscheme for Neovim
" Generated from kitty theme: 1984_dark
...
let g:colors_name = '1984_dark'
set termguicolors

" Define colors
let s:none = 'NONE'
let s:bg_solid = '#0d0f31'
let s:bg = get(g:, 'kitty_themes_transparent', 0) ? s:none : s:bg_solid
let s:fg = '#ffffff'
let s:cursor = '#59e1e3'
let s:selection = '#00d5eb'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#ff16b0')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#ffea16')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#46bdff')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#59e1e3')
...
let s:color8 = '#000000'
let s:color9 = '#ff16b0'
let s:color10 = '#b3f361'
let s:color11 = '#ffea16'
let s:color12 = '#46bdff'
let s:color13 = '#f806fa'
let s:color14 = '#6be4e6'
let s:color15 = '#feffff'
