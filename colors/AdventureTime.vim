" AdventureTime colorscheme for Neovim
" Generated from kitty theme: AdventureTime
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'AdventureTime'
set termguicolors
" Define colors
let s:none = 'NONE'
let s:bg_solid = '#1e1c44'
let s:bg = get(g:, 'kitty_themes_transparent', 0) ? s:none : s:bg_solid
let s:fg = '#f8dbc0'
let s:cursor = '#eebf37'
let s:selection = '#6f6a4e'
...
let s:color8 = '#4e7bbf'
let s:color9 = '#fc5e59'
let s:color10 = '#9dff6e'
let s:color11 = '#efc11a'
let s:color12 = '#1896c6'
let s:color13 = '#9a5952'
let s:color14 = '#c8f9f3'
let s:color15 = '#f5f4fb'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#bc0013')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#e6741d')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#0f49c6')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#6fa497')
