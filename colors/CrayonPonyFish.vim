" CrayonPonyFish colorscheme for Neovim
" Generated from kitty theme: CrayonPonyFish
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'CrayonPonyFish'
set termguicolors
" Define colors
let s:none = 'NONE'
let s:bg_solid = '#140607'
...
let s:color8 = '#3c2a2e'
let s:color9 = '#c5245c'
let s:color10 = '#8dff56'
let s:color11 = '#c7371d'
let s:color12 = '#cfc9ff'
let s:color13 = '#fb6cb9'
let s:color14 = '#ffceae'
let s:color15 = '#af949d'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#90002a')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#aa301b')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#8b87af')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#e8a766')
