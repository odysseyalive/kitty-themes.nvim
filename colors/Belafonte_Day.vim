" Belafonte_Day colorscheme for Neovim
" Generated from kitty theme: Belafonte_Day
hi clear
if exists('syntax_on')
  syntax reset
endif
let g:colors_name = 'Belafonte_Day'
set termguicolors
" Define colors
let s:none = 'NONE'
let s:bg_solid = '#d4ccb9'
