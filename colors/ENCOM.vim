" ENCOM colorscheme for Neovim
" Generated from kitty theme: ENCOM
hi clear
if exists('syntax_on')
  syntax reset
endif
...
let s:color8 = '#545454'
let s:color9 = '#ff0000'
let s:color10 = '#00ee00'
let s:color11 = '#ffff00'
let s:color12 = '#0000ff'
let s:color13 = '#ff00ff'
let s:color14 = '#00cdcd'
...
call s:hi('DiagnosticUnderlineError', s:none, s:none, 'underline sp=#9f0000')
call s:hi('DiagnosticUnderlineWarn', s:none, s:none, 'underline sp=#ffcf00')
call s:hi('DiagnosticUnderlineInfo', s:none, s:none, 'underline sp=#0081ff')
call s:hi('DiagnosticUnderlineHint', s:none, s:none, 'underline sp=#008b8b')
